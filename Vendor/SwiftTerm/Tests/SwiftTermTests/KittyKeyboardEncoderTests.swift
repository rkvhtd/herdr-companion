...
final class KittyKeyboardEncoderTests: XCTestCase {
    ...
    func testReportEventsKeepsLegacyEscapePressAndReportsRepeatAndRelease() {
        for (eventType, expected) in [
            (KittyKeyboardEventType.press, "\u{1b}"),
            (.repeatPress, "\u{1b}[27;1:2u"),
            (.release, "\u{1b}[27;1:3u"),
        ] {
            assertEncode(KittyKeyEvent(key: .functional(.escape),
                                       modifiers: [],
                                       eventType: eventType,
                                       text: nil,
                                       shiftedKey: nil,
