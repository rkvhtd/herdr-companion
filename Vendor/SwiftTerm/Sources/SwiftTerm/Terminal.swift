...
//                break
    ...
    public func resize (cols: Int, rows: Int)
    {
        ...
        // herdr: a resize is not the end of the application's frame. Ending DEC
        // 2026 here published a half-drawn screen every time the window changed
        // size; the existing end marker and the one second safety timer still
        // decide when the batch is over.
